...
import { Plus, Loader, Trash2, FolderTree, AlertCircle } from 'lucide-react';
            ...
            return (
              <div key={main.id} className="bg-white dark:bg-zinc-900 border border-gray-100 dark:border-white/5 rounded-2xl p-4">
                <div className="flex items-center justify-between">
                  <span className="flex items-center gap-2 font-bold text-gray-900 dark:text-zinc-100">
                ...
                {subs.length > 0 && (
                  <div className="flex flex-wrap gap-2 mt-3 pl-6">
                    {subs.map(s => (
                      <span key={s.id} className="inline-flex items-center gap-1.5 pl-3 pr-1.5 py-1 rounded-full bg-gray-100 dark:bg-white/5 text-sm text-gray-700 dark:text-zinc-300">
                        {s.name}
